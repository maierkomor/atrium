...
#ifndef _WFCCORE_ESP32_H
#define _WFCCORE_ESP32_H
...
class Message
{
	...
	*/
	virtual void toJSON(stream &json, bool full = true, unsigned indLvl = 0) const = 0;
	...
	* @param indLvl: indention level
	*/
	virtual void toASCII(stream &out, bool full = true, size_t indLvl = 0) const = 0;
	...
	* @param indLvl: indention level
	*/
	virtual void toPbt(stream &out, bool full = false, size_t indLvl = 0) const = 0;
 ...
 * variant:       gen_indent
 */
extern void gen_indent(stream &out, ssize_t n);
 ...
 * variant:       gen_bytes
 */
extern void gen_bytes(stream &out, const uint8_t *str, size_t len, size_t indent);
 ...
 * variant:       gen_string
 */
extern void gen_string(stream &out, size_t indent, const char *str, size_t len);
 ...
 */
extern void ascii_indent(stream &out, ssize_t n, const char *fname);
 ...
 * variant:       pbt_bool
 */
extern void pbt_bool(stream &out, ssize_t n, const char *fname, bool v);
 ...
 * variant:       pbt_indent
 */
extern void pbt_indent(stream &out, ssize_t n, const char *fname);
 ...
 */
template <typename T>
void pbt_numeric(stream &out, ssize_t n, const char *fname, T v)
{
	gen_indent(out,n);
	out << fname;
	out << ": ";
 ...
 * variant:       pbt_string
 */
extern void pbt_string(stream &out, size_t indent, const char *str, size_t len, const char *fname = 0);
