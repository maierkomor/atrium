...
void EnvConfig::toASCII(stream &o, size_t indent) const
{
	o << "EnvConfig {";
	++indent;
...
void EnvConfig::toJSON(stream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_path()) {
...
void ScreenConfig::toASCII(stream &o, size_t indent) const
{
	o << "ScreenConfig {";
	++indent;
	ascii_indent(o,indent);
...
void ScreenConfig::toJSON(stream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
...
void Dref::toASCII(stream &o, size_t indent) const
{
	o << "Dref {";
	++indent;
	ascii_string(o,indent,m_name.data(),m_name.size(),"name");
...
void Dref::toJSON(stream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_name()) {
...
void DataIdVar::toASCII(stream &o, size_t indent) const
{
	o << "DataIdVar {";
	++indent;
...
void DataIdVar::toJSON(stream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_id()) {
...
void XPlaneConfig::toASCII(stream &o, size_t indent) const
{
	o << "XPlaneConfig {";
	++indent;
...
void XPlaneConfig::toJSON(stream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_ip4addr()) {
