...
void WifiConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // WifiConfig";
	++indent;
	if (full || has_ssid()) {
...
void WifiConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_ssid()) {
...
void MQTT::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // MQTT";
	++indent;
	if (full || has_uri()) {
...
void MQTT::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_uri()) {
...
void Date::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // Date";
	++indent;
	if (full || has_day()) {
...
void Date::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_day()) {
...
void AtAction::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // AtAction";
	++indent;
	if (full || has_day()) {
...
void AtAction::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_day()) {
...
void Influx::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // Influx";
	++indent;
...
void Influx::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_hostname()) {
...
void UartSettings::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // UartSettings";
	++indent;
	if (full || has_port()) {
...
void UartSettings::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_port()) {
...
void FtpHttpConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // FtpHttpConfig";
	++indent;
	if (full || has_port()) {
...
void FtpHttpConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_port()) {
...
void TerminalConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // TerminalConfig";
	++indent;
	if (full || has_uart_rx()) {
...
void TerminalConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_uart_rx()) {
...
void Trigger::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // Trigger";
	++indent;
	if (full || has_event()) {
...
void Trigger::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_event()) {
...
void AppParam::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // AppParam";
	++indent;
	if (full || has_key()) {
...
void AppParam::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_key()) {
...
void AppParam::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_key()) {
...
void EventTimer::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // EventTimer";
	++indent;
	if (full || has_name()) {
...
void EventTimer::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void FunctionConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // FunctionConfig";
	++indent;
	if (full || has_name()) {
...
void FunctionConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void FunctionConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_name()) {
...
void SignalConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // SignalConfig";
	++indent;
	if (full || has_name()) {
...
void SignalConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void SignalConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_name()) {
...
void OwDeviceConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // OwDeviceConfig";
	++indent;
	if (full || has_id()) {
...
void OwDeviceConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_id()) {
...
void StateConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // StateConfig";
	++indent;
	if (full || has_name()) {
...
void StateConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void StateMachineConfig::toASCII(stream &o, bool full, size_t indent) const
{
...
void StateMachineConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void StateMachineConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_name()) {
...
void ThresholdConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // ThresholdConfig";
	++indent;
	if (full || has_name()) {
...
void ThresholdConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void EnvConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // EnvConfig";
	++indent;
	if (full || has_path()) {
...
void EnvConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_path()) {
...
ssize_t EnvConfig::fromMemory(const void *b, ssize_t s)
{
	...
	while (a < e) {
		...
		a += fn;
		switch (fid) {
		case 0xa:	// path id 1, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
			...
			break;
		case 0x12:	// title id 2, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
...
void EnvConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_path()) {
...
void ScreenConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // ScreenConfig";
	++indent;
...
void ScreenConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || (0 != m_envs.size())) {
...
ssize_t ScreenConfig::fromMemory(const void *b, ssize_t s)
{
	...
	while (a < e) {
		...
		case 0xa:	// envs id 1, type EnvConfig, coding byte[]
			...
			break;
		case 0x22:	// font_tiny id 4, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
			...
			break;
		case 0x2a:	// font_small id 5, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
			...
			break;
		case 0x32:	// font_medium id 6, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
			...
			break;
		case 0x3a:	// font_large id 7, type estring, coding byte[]
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				a += n;
...
void ScreenConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
...
void Dref::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // Dref";
	++indent;
	if (full || has_name()) {
...
void Dref::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_name()) {
...
void DataIdVar::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // DataIdVar";
	++indent;
	if (full || has_id()) {
...
void DataIdVar::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_id()) {
...
void XPlaneConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // XPlaneConfig";
	++indent;
	if (full || has_ip4addr()) {
...
void XPlaneConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_ip4addr()) {
...
void XPlaneConfig::toJSON(stream &json, bool full, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (full || has_ip4addr()) {
...
void NodeConfig::toASCII(stream &o, bool full, size_t indent) const
{
	o << "{ // NodeConfig";
	++indent;
	if (full || has_magic()) {
...
void NodeConfig::toPbt(stream &o, bool full, size_t indent) const
{
	o << '{';
	++indent;
	if (full || has_magic()) {
...
ssize_t NodeConfig::fromMemory(const void *b, ssize_t s)
{
	...
	while (a < e) {
		...
		case 0xda:	// screen id 27, type ScreenConfig, coding byte[]
			...
			break;
			#endif // CONFIG_DISPLAY
		case 0xe0:	// history id 28, type uint32_t, coding varint
			{
				varint_t v;
				int n = read_varint(a,e-a,&v);
				if (n <= 0)
...
int NodeConfig::setByName(const char *name, const char *value)
{
	...
	if (0 == strcmp(name,"history")) {
		...
		int r = parse_ascii_u32(&m_history,value);
		if (r > 0)
