...
class NodeConfig : public Message
{
	...
	*/
	...
	/*!
	* Function for querying if max_on_time has been set.
	* @return true if max_on_time is set.
	*/
	...
	/*!
	* Function for querying if threshold_off has been set.
	* @return true if threshold_off is set.
	*/
	...
	uint64_t threshold_off() const __attribute__ ((deprecated));
	
	// deprecated optional unsigned threshold_on, id 36
	/*!
	* Function for querying if threshold_on has been set.
	* @return true if threshold_on is set.
	*/
	...
	uint64_t threshold_on() const __attribute__ ((deprecated));
	...
	*/
	...
	/*!
	* Function for querying if lightctrl has been set.
	* @return true if lightctrl is set.
	*/
	bool has_lightctrl() const;
	//! Function to reset lightctrl to its default/unset value.
	void clear_lightctrl();
	//! Get value of lightctrl.
	bool lightctrl() const;
	//! Set lightctrl using a constant reference
	void set_lightctrl(bool v);
	/*!
	* Provide mutable access to lightctrl.
	* @return pointer to member variable of lightctrl.
	*/
	...
	*/
	...
	// deprecated unsigned threshold_off, id 35
	//! Set threshold_off using a constant reference
	void set_threshold_off(uint64_t v);
	// deprecated unsigned threshold_on, id 36
