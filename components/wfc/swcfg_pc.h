...
#define OUTPUT_TO_PROTOBUF_TEXT 1
#include <iosfwd>
#include <ostream>
#include <string>
#include <map>
...
class ScreenConfig : public Message
{
	...
	*/
	...
	const std::string &font_tiny() const;
	/*!
	...
	*/
	...
	void set_font_tiny(const std::string &v);
	...
	*/
	...
	const std::string &font_small() const;
	/*!
	...
	*/
	...
	void set_font_small(const std::string &v);
	...
	*/
	...
	const std::string &font_medium() const;
	/*!
	...
	*/
	...
	void set_font_medium(const std::string &v);
	...
	*/
	std::string *mutable_font_medium();
	...
	*/
	...
	const std::string &font_large() const;
	/*!
	...
	*/
	...
	void set_font_large(const std::string &v);
	...
	*/
	...
	std::string m_font_tiny;
	//! string font_small, id 5
	std::string m_font_small;
	//! string font_medium, id 6
	std::string m_font_medium;
	//! string font_large, id 7
	std::string m_font_large;
	//! EnvConfig envs, id 1
...
class Dref : public Message
{
	...
	bool operator != (const Dref &r) const;
	bool operator == (const Dref &r) const;
	...
	*/
	...
	/*!
	* Function for querying if alias has been set.
	* @return true if alias is set.
	*/
	bool has_alias() const;
	//! Function to reset alias to its default/unset value.
	void clear_alias();
	//! Get value of alias.
	const std::string &alias() const;
	/*!
	* Function for setting alias using binary data.
	* @param data pointer to binary data
	* @param s number of bytes at data pointer
	*/
	void set_alias(const void *data, size_t s);
	//! Set alias using a constant reference
	void set_alias(const std::string &v);
	//! Set alias using a pointer to a null-terminated C-string.
	void set_alias(const char *);
	/*!
	* Provide mutable access to alias.
	* @return pointer to member variable of alias.
	*/
...
class DataIdVar : public Message
{
	public:
	DataIdVar()
	{
	...
	bool operator != (const DataIdVar &r) const;
	bool operator == (const DataIdVar &r) const;
	...
	*/
	...
	/*!
	* Function for querying if idx has been set.
	* @return true if idx is set.
	*/
	bool has_idx() const;
	//! Function to reset idx to its default/unset value.
	void clear_idx();
	//! Get value of idx.
	uint64_t idx() const;
	//! Set idx using a constant reference
	void set_idx(uint64_t v);
	/*!
	* Provide mutable access to idx.
	* @return pointer to member variable of idx.
	*/
	uint64_t *mutable_idx();
	
	// optional string varname, id 3
	/*!
	* Function for querying if varname has been set.
	* @return true if varname is set.
	*/
	bool has_varname() const;
	//! Function to reset varname to its default/unset value.
	void clear_varname();
	//! Get value of varname.
	const std::string &varname() const;
	/*!
	* Function for setting varname using binary data.
	* @param data pointer to binary data
	* @param s number of bytes at data pointer
	*/
	void set_varname(const void *data, size_t s);
	//! Set varname using a constant reference
	void set_varname(const std::string &v);
	//! Set varname using a pointer to a null-terminated C-string.
	void set_varname(const char *);
	/*!
	* Provide mutable access to varname.
	* @return pointer to member variable of varname.
	*/
...
class XPlaneConfig : public Message
{
	public:
	XPlaneConfig()
	{
	...
	bool operator != (const XPlaneConfig &r) const;
	bool operator == (const XPlaneConfig &r) const;
	...
	*/
	...
	/*!
	* Function for querying if ip4addr has been set.
	* @return true if ip4addr is set.
	*/
	bool has_ip4addr() const;
	//! Function to reset ip4addr to its default/unset value.
	void clear_ip4addr();
	//! Get value of ip4addr.
	uint32_t ip4addr() const;
	//! Set ip4addr using a constant reference
	void set_ip4addr(uint32_t v);
	/*!
	* Provide mutable access to ip4addr.
	* @return pointer to member variable of ip4addr.
	*/
	uint32_t *mutable_ip4addr();
	
	// optional fixed16 refport, id 2
	/*!
	* Function for querying if refport has been set.
	* @return true if refport is set.
	*/
	bool has_refport() const;
	//! Function to reset refport to its default/unset value.
	void clear_refport();
	//! Get value of refport.
	uint16_t refport() const;
	//! Set refport using a constant reference
	void set_refport(uint16_t v);
	/*!
	* Provide mutable access to refport.
	* @return pointer to member variable of refport.
	*/
	uint16_t *mutable_refport();
	
	// optional fixed16 dataport, id 3
	/*!
	* Function for querying if dataport has been set.
	* @return true if dataport is set.
	*/
	bool has_dataport() const;
	//! Function to reset dataport to its default/unset value.
	void clear_dataport();
	//! Get value of dataport.
	uint16_t dataport() const;
	//! Set dataport using a constant reference
	void set_dataport(uint16_t v);
	/*!
	* Provide mutable access to dataport.
	* @return pointer to member variable of dataport.
	*/
	uint16_t *mutable_dataport();
	
	// repeated DataIdVar dataids, id 4
	//! Function get const-access to the elements of dataids.
	const std::vector<DataIdVar> &dataids() const;
	//! Function to get the number of elements in dataids.
	size_t dataids_size() const;
	/*!
	* Function to append a element to dataids.
	* @return point to newly added element.
	*/
	DataIdVar* add_dataids();
	//! Function to reset dataids to its default/unset value.
	void clear_dataids();
	//! Get value of element x of dataids.
	const DataIdVar &dataids(unsigned x) const;
	//! Set dataids using a constant reference
	void set_dataids(unsigned x, const DataIdVar &v);
	/*!
	* Provide mutable access to dataids.
	* @return pointer to member variable of dataids.
	*/
	DataIdVar *mutable_dataids(unsigned x);
	//! Function to get mutable access to all elements of dataids.
	std::vector<DataIdVar> *mutable_dataids();
	
	// repeated Dref drefs, id 5
	//! Function get const-access to the elements of drefs.
	const std::vector<Dref> &drefs() const;
	//! Function to get the number of elements in drefs.
	size_t drefs_size() const;
	/*!
	* Function to append a element to drefs.
	* @return point to newly added element.
	*/
	Dref* add_drefs();
	//! Function to reset drefs to its default/unset value.
	void clear_drefs();
	//! Get value of element x of drefs.
	const Dref &drefs(unsigned x) const;
	//! Set drefs using a constant reference
	void set_drefs(unsigned x, const Dref &v);
	/*!
	* Provide mutable access to drefs.
	* @return pointer to member variable of drefs.
	*/
	Dref *mutable_drefs(unsigned x);
	//! Function to get mutable access to all elements of drefs.
	std::vector<Dref> *mutable_drefs();
	
	
	protected:
	Message *p_getMember(const char *s, unsigned n);
	Message *p_getMember(const char *s, unsigned n, unsigned i);
	//! fixed32 ip4addr, id 1
	uint32_t m_ip4addr = 0;
	//! fixed16 refport, id 2
	uint16_t m_refport = 0;
	//! fixed16 dataport, id 3
	uint16_t m_dataport = 0;
	//! DataIdVar dataids, id 4
	std::vector<DataIdVar> m_dataids;
	//! Dref drefs, id 5
	std::vector<Dref> m_drefs;
...
class NodeConfig : public Message
{
	...
	*/
	...
	void set_otasrv(const std::string &v);
	...
	*/
	...
	/*!
	* Function for querying if history has been set.
	* @return true if history is set.
	*/
	bool has_history() const;
	//! Function to reset history to its default/unset value.
	void clear_history();
	//! Get value of history.
	uint64_t history() const;
	//! Set history using a constant reference
	void set_history(uint64_t v);
	/*!
	* Provide mutable access to history.
	* @return pointer to member variable of history.
	*/
	uint64_t *mutable_history();
	...
	*/
	...
	/*!
	* Function for querying if xplane has been set.
	* @return true if xplane is set.
	*/
	bool has_xplane() const;
	//! Function to reset xplane to its default/unset value.
	void clear_xplane();
	//! Get value of xplane.
	const XPlaneConfig &xplane() const;
	/*!
	* Function for setting xplane using binary data.
	* @param data pointer to binary data
	* @param s number of bytes at data pointer
	*/
	void set_xplane(const void *data, size_t s);
	//! Set xplane using a constant reference
	void set_xplane(const XPlaneConfig &v);
	/*!
	* Provide mutable access to xplane.
	* @return pointer to member variable of xplane.
	*/
	XPlaneConfig *mutable_xplane();
	...
	uint64_t m_actions_enable = 1;
	//! unsigned dim_step, id 37
	uint64_t m_dim_step = 0;
	//! unsigned cpu_freq, id 3
	uint64_t m_cpu_freq = 0;
	//! unsigned pwm_freq, id 39
	uint64_t m_pwm_freq = 0;
	//! unsigned history, id 28
	uint64_t m_history = 256;
	//! unsigned station2ap_time, id 13
	uint64_t m_station2ap_time = 0;
	//! fixed32 magic, id 0
	uint32_t m_magic = 0xAE54EDC0;
	...
	//! XPlaneConfig xplane, id 60
	XPlaneConfig m_xplane;
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_addr4));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_netmask4));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_gateway4));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_keepalive));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_day));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_min_of_day));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_baudrate));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_tx_bufsize));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_rx_bufsize));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_start));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_uValue));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_dValue));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_fValue));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_time));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_id));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_ini_st));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_low));
}
...
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_high));
}
...
inline const std::string &EnvConfig::path() const
{
	return m_path;
}
...
inline std::string *EnvConfig::mutable_path()
{
	return &m_path;
}
...
inline void EnvConfig::set_path(const std::string &v)
{
	m_path = v;
}
...
inline const std::string &EnvConfig::title() const
{
	return m_title;
}
...
inline std::string *EnvConfig::mutable_title()
{
	return &m_title;
}
...
inline void EnvConfig::set_title(const std::string &v)
{
	m_title = v;
}
...
inline const std::string &EnvConfig::action() const
{
	return m_action;
}
...
inline std::string *EnvConfig::mutable_action()
{
	return &m_action;
}
...
inline void EnvConfig::set_action(const std::string &v)
{
	m_action = v;
}
...
inline const std::string &ScreenConfig::font_tiny() const
{
	return m_font_tiny;
}
...
inline std::string *ScreenConfig::mutable_font_tiny()
{
	return &m_font_tiny;
}
...
inline void ScreenConfig::set_font_tiny(const std::string &v)
{
	m_font_tiny = v;
}
...
inline const std::string &ScreenConfig::font_small() const
{
	return m_font_small;
}
...
inline std::string *ScreenConfig::mutable_font_small()
{
	return &m_font_small;
}
...
inline void ScreenConfig::set_font_small(const std::string &v)
{
	m_font_small = v;
}
...
inline const std::string &ScreenConfig::font_medium() const
{
...
inline std::string *ScreenConfig::mutable_font_medium()
{
	return &m_font_medium;
}
...
inline void ScreenConfig::set_font_medium(const std::string &v)
{
	m_font_medium = v;
}
...
inline const std::string &ScreenConfig::font_large() const
{
	return m_font_large;
}
...
inline std::string *ScreenConfig::mutable_font_large()
{
	return &m_font_large;
}
...
inline void ScreenConfig::set_font_large(const std::string &v)
{
	m_font_large = v;
}
...
inline size_t Dref::getMaxSize()
{
	// optional string name, id 1 has unlimited size
	// optional string alias, id 2 has unlimited size
	// optional unsigned freq, id 3 has maximum size 11
	return SIZE_MAX;
}

inline const std::string &Dref::name() const
{
	return m_name;
}

inline bool Dref::has_name() const
{
	return !m_name.empty();
}
 ...
 * It will reset the value to the default value.
 */
inline void Dref::clear_name()
{
	m_name.clear();
}

inline std::string *Dref::mutable_name()
{
	return &m_name;
}

inline void Dref::set_name(const void *data, size_t s)
{
	m_name.assign((const char *)data,s);
}

inline void Dref::set_name(const char *data)
{
	m_name = data;
}

inline void Dref::set_name(const std::string &v)
{
	m_name = v;
}
...
inline const std::string &Dref::alias() const
{
	return m_alias;
}

inline bool Dref::has_alias() const
{
 ...
 * It will reset the value to the default value.
 */
inline void Dref::clear_alias()
{
	m_alias.clear();
}

inline std::string *Dref::mutable_alias()
{
	return &m_alias;
}

inline void Dref::set_alias(const void *data, size_t s)
{
	m_alias.assign((const char *)data,s);
}

inline void Dref::set_alias(const char *data)
{
	m_alias = data;
}

inline void Dref::set_alias(const std::string &v)
{
	m_alias = v;
}
...
inline uint64_t Dref::freq() const
{
	return m_freq;
}

inline bool Dref::has_freq() const
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_freq));
}
 ...
 * It will reset the value to the default value.
 */
inline void Dref::clear_freq()
{
	p_validbits &= ~((uint8_t)1U << 0);
	m_freq = 10;
}

inline uint64_t *Dref::mutable_freq()
{
...
inline void Dref::set_freq(uint64_t v)
{
	m_freq = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline size_t DataIdVar::getMaxSize()
{
	// optional unsigned id, id 1 has maximum size 11
	// optional unsigned idx, id 2 has maximum size 11
	// optional string varname, id 3 has unlimited size
	return SIZE_MAX;
}

inline uint64_t DataIdVar::id() const
{
	return m_id;
}

inline bool DataIdVar::has_id() const
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_id));
}
 ...
 * It will reset the value to the default value.
 */
inline void DataIdVar::clear_id()
{
	p_validbits &= ~((uint8_t)1U << 0);
	m_id = 0;
}

inline uint64_t *DataIdVar::mutable_id()
{
	if (0 == (p_validbits & ((uint8_t)1U << vb_id))) {
		p_validbits |= ((uint8_t)1U << 0);
		m_id = 0;
...
inline void DataIdVar::set_id(uint64_t v)
{
	m_id = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline uint64_t DataIdVar::idx() const
{
	return m_idx;
}

inline bool DataIdVar::has_idx() const
{
	return m_idx != 0;
}
 ...
 * It will reset the value to the default value.
 */
inline void DataIdVar::clear_idx()
{
	m_idx = 0;
}

inline uint64_t *DataIdVar::mutable_idx()
{
	return &m_idx;
}

inline void DataIdVar::set_idx(uint64_t v)
{
	m_idx = v;
}
...
inline const std::string &DataIdVar::varname() const
{
	return m_varname;
}

inline bool DataIdVar::has_varname() const
{
	return !m_varname.empty();
}
 ...
 * It will reset the value to the default value.
 */
inline void DataIdVar::clear_varname()
{
	m_varname.clear();
}

inline std::string *DataIdVar::mutable_varname()
{
	return &m_varname;
}

inline void DataIdVar::set_varname(const void *data, size_t s)
{
	m_varname.assign((const char *)data,s);
}

inline void DataIdVar::set_varname(const char *data)
{
	m_varname = data;
}

inline void DataIdVar::set_varname(const std::string &v)
{
	m_varname = v;
}
...
inline size_t XPlaneConfig::getMaxSize()
{
	// optional fixed32 ip4addr, id 1 has maximum size 5
	// optional fixed16 refport, id 2 has maximum size 3
	// optional fixed16 dataport, id 3 has maximum size 3
	// repeated DataIdVar dataids, id 4 has unlimited size
	// repeated Dref drefs, id 5 has unlimited size
	return SIZE_MAX;
}

inline uint32_t XPlaneConfig::ip4addr() const
{
	return m_ip4addr;
}

inline bool XPlaneConfig::has_ip4addr() const
{
	return 0 != (p_validbits & ((uint8_t)1U << vb_ip4addr));
}
 ...
 * It will reset the value to the default value.
 */
inline void XPlaneConfig::clear_ip4addr()
{
	p_validbits &= ~((uint8_t)1U << 0);
	m_ip4addr = 0;
}

inline uint32_t *XPlaneConfig::mutable_ip4addr()
{
...
inline void XPlaneConfig::set_ip4addr(uint32_t v)
{
	m_ip4addr = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline uint16_t XPlaneConfig::refport() const
{
	return m_refport;
}

inline bool XPlaneConfig::has_refport() const
{
	return m_refport != 0;
}
 ...
 * It will reset the value to the default value.
 */
inline void XPlaneConfig::clear_refport()
{
	m_refport = 0;
}

inline uint16_t *XPlaneConfig::mutable_refport()
{
	return &m_refport;
}

inline void XPlaneConfig::set_refport(uint16_t v)
{
	m_refport = v;
}
...
inline uint16_t XPlaneConfig::dataport() const
{
	return m_dataport;
}

inline bool XPlaneConfig::has_dataport() const
{
	return m_dataport != 0;
}
 ...
 * It will reset the value to the default value.
 */
inline void XPlaneConfig::clear_dataport()
{
	m_dataport = 0;
}

inline uint16_t *XPlaneConfig::mutable_dataport()
{
	return &m_dataport;
}

inline void XPlaneConfig::set_dataport(uint16_t v)
{
	m_dataport = v;
}
...
inline const DataIdVar &XPlaneConfig::dataids(unsigned x) const
{
	return m_dataids[x];
}

inline const std::vector<DataIdVar> &XPlaneConfig::dataids() const
{
	return m_dataids;
}
 ...
 * It will reset the value to the default value.
 */
inline void XPlaneConfig::clear_dataids()
{
	m_dataids.clear();
}

inline DataIdVar *XPlaneConfig::mutable_dataids(unsigned x)
{
	if (x >= m_dataids.size())
...
inline std::vector<DataIdVar> *XPlaneConfig::mutable_dataids()
{
	return &m_dataids;
}

inline DataIdVar *XPlaneConfig::add_dataids()
{
	m_dataids.resize(m_dataids.size()+1);
	return &m_dataids.back();
}

inline void XPlaneConfig::set_dataids(unsigned x, const DataIdVar &v)
{
	assert(x < m_dataids.size());
	m_dataids[x] = v;
}

inline size_t XPlaneConfig::dataids_size() const
{
	return m_dataids.size();
}



inline const Dref &XPlaneConfig::drefs(unsigned x) const
{
	return m_drefs[x];
}

inline const std::vector<Dref> &XPlaneConfig::drefs() const
{
	return m_drefs;
}
 ...
 * It will reset the value to the default value.
 */
inline void XPlaneConfig::clear_drefs()
{
	m_drefs.clear();
}

inline Dref *XPlaneConfig::mutable_drefs(unsigned x)
{
	if (x >= m_drefs.size())
		m_drefs.resize(x+1);
	return &m_drefs[x];
...
inline std::vector<Dref> *XPlaneConfig::mutable_drefs()
{
	return &m_drefs;
}

inline Dref *XPlaneConfig::add_drefs()
{
	m_drefs.resize(m_drefs.size()+1);
	return &m_drefs.back();
}

inline void XPlaneConfig::set_drefs(unsigned x, const Dref &v)
{
	assert(x < m_drefs.size());
	m_drefs[x] = v;
}

inline size_t XPlaneConfig::drefs_size() const
{
	return m_drefs.size();
}
...
inline size_t NodeConfig::getMaxSize()
{
	...
	// optional unsigned history, id 28 has maximum size 12
	...
	// optional XPlaneConfig xplane, id 60 has maximum size 11
	return SIZE_MAX;
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_magic));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_station));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_softap));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_mqtt));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_dmesg_size));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_influx));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_station2ap_time));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_actions_enable));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_udp_ctrl_port));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_ftpd));
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_httpd));
}
...
inline const std::string &NodeConfig::otasrv() const
{
	return m_otasrv;
}
...
inline std::string *NodeConfig::mutable_otasrv()
{
	return &m_otasrv;
}
...
inline void NodeConfig::set_otasrv(const std::string &v)
{
	m_otasrv = v;
}
...
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_screen));
}
...
inline uint64_t NodeConfig::history() const
{
	return m_history;
}

inline bool NodeConfig::has_history() const
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_history));
}
 ...
 * It will reset the value to the default value.
 */
inline void NodeConfig::clear_history()
{
	p_validbits &= ~((uint16_t)1U << 12);
	m_history = 256;
}

inline uint64_t *NodeConfig::mutable_history()
{
...
inline void NodeConfig::set_history(uint64_t v)
{
	m_history = v;
	p_validbits |= ((uint16_t)1U << 12);
}
...
inline const XPlaneConfig &NodeConfig::xplane() const
{
	return m_xplane;
}

inline bool NodeConfig::has_xplane() const
{
	return 0 != (p_validbits & ((uint16_t)1U << vb_xplane));
}
 ...
 * It will reset the value to the default value.
 */
inline void NodeConfig::clear_xplane()
{
	p_validbits &= ~((uint16_t)1U << 13);
	m_xplane.clear();
}

inline XPlaneConfig *NodeConfig::mutable_xplane()
{
...
inline void NodeConfig::set_xplane(const void *data, size_t s)
{
	m_xplane.fromMemory((const char *)data,s);
	p_validbits |= ((uint16_t)1U << 13);
}

inline void NodeConfig::set_xplane(const XPlaneConfig &v)
{
	m_xplane = v;
	p_validbits |= ((uint16_t)1U << 13);
}
