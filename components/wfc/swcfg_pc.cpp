...
void EnvConfig::toASCII(std::ostream &o, size_t indent) const
{
	o << "EnvConfig {";
	++indent;
...
void EnvConfig::toJSON(std::ostream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_path()) {
...
void ScreenConfig::toASCII(std::ostream &o, size_t indent) const
{
	o << "ScreenConfig {";
	++indent;
	ascii_indent(o,indent);
...
void ScreenConfig::toJSON(std::ostream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
...
void Dref::toASCII(std::ostream &o, size_t indent) const
{
	o << "Dref {";
	++indent;
	ascii_string(o,indent,m_name.data(),m_name.size(),"name");
...
void Dref::toJSON(std::ostream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_name()) {
...
void DataIdVar::toASCII(std::ostream &o, size_t indent) const
{
	o << "DataIdVar {";
	++indent;
...
void DataIdVar::toJSON(std::ostream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_id()) {
...
void XPlaneConfig::toASCII(std::ostream &o, size_t indent) const
{
	o << "XPlaneConfig {";
	++indent;
...
void XPlaneConfig::toJSON(std::ostream &json, unsigned indLvl) const
{
	char fsep = '{';
	++indLvl;
	if (has_ip4addr()) {
	...
	if (size_t s = m_dataids.size()) {
		...
		for (;;) {
			json_indent(json,indLvl,0);
			m_dataids[i].toJSON(json,indLvl);
			++i;
			if (i == s)
				break;
			json << ",\n";
...
ssize_t NodeConfig::toMemory(uint8_t *b, ssize_t s) const
{
	...
	// has xplane?
	if (0 != (p_validbits & ((uint16_t)1U << 15))) {
