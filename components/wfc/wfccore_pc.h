...
#ifndef _WFCCORE_PC_H
#define _WFCCORE_PC_H
...
class Message
{
	...
	*/
	virtual void toJSON(std::ostream &json, bool full = true, unsigned indLvl = 0) const = 0;
	...
	* @param indLvl: indention level
	*/
	virtual void toASCII(std::ostream &out, bool full = true, size_t indLvl = 0) const = 0;
	
	/*!
	* output message as protobuf text to stream
	* @param out: output stream
	* @param indLvl: indention level
	*/
	virtual void toPbt(std::ostream &out, bool full = false, size_t indLvl = 0) const = 0;
	...
	*/
	...
	protected:
	virtual Message *p_getMember(const char *s, unsigned n) = 0;
	virtual Message *p_getMember(const char *s, unsigned n, unsigned x) = 0;
};
 ...
 * variant:       gen_indent
 */
extern void gen_indent(std::ostream &out, ssize_t n);
 ...
 * variant:       gen_bytes
 */
extern void gen_bytes(std::ostream &out, const uint8_t *str, size_t len, size_t indent);
 ...
 * variant:       gen_string
 */
extern void gen_string(std::ostream &out, size_t indent, const char *str, size_t len);
 ...
 */
extern void ascii_indent(std::ostream &out, ssize_t n, const char *fname);
 ...
 * variant:       pbt_bool
 */
extern void pbt_bool(std::ostream &out, ssize_t n, const char *fname, bool v);
 ...
 * variant:       pbt_indent
 */
extern void pbt_indent(std::ostream &out, ssize_t n, const char *fname);


/* included from: (WFC_ROOT)/share/ascii_funcs.cc
 * function:      pbt_numeric
 * variant:       pbt_numeric
 */
template <typename T>
void pbt_numeric(std::ostream &out, ssize_t n, const char *fname, T v)
{
	gen_indent(out,n);
	out << fname;
	out << ": ";
 ...
 * variant:       pbt_string
 */
extern void pbt_string(std::ostream &out, size_t indent, const char *str, size_t len, const char *fname = 0);
