 ...
 * variant:       gen_indent
 */
void gen_indent(std::ostream &out, ssize_t n)
{
	out.put('\n');
	while (n > 0) {
		out.put('\t');
 ...
 * variant:       gen_bytes
 */
void gen_bytes(std::ostream &out, const uint8_t *str, size_t len, size_t indent)
{
 ...
 * variant:       gen_string
 */
void gen_string(std::ostream &out, size_t indent, const char *str, size_t len)
{
	out << '"';
	unsigned cil = 0;
	while (len) {
...
{
	ascii_indent(out,indent,fname);
	gen_bytes(out,str,len,indent);
}
 ...
 * variant:       pbt_bool
 */
void pbt_bool(std::ostream &out, ssize_t n, const char *fname, bool v)
{
	gen_indent(out,n);
	out << fname;
	out << (v ? ": true" : ": false");
 ...
 * variant:       pbt_indent
 */
void pbt_indent(std::ostream &out, ssize_t n, const char *fname)
{
	gen_indent(out,n);
	out << fname;
	out.put(':');
 ...
 * variant:       pbt_string
 */
void pbt_string(std::ostream &out, size_t indent, const char *str, size_t len, const char *fname )
{
	if (fname)
		pbt_indent(out,indent,fname);
	gen_string(out,indent,str,len);
}
