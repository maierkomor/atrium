...
class DisplayConfig : public Message
{
	...
	*/
	...
	const std::vector<std::string> &skip_env() const;
	...
	* @return point to newly added element.
	*/
	void add_skip_env(const std::string &v);
	...
	*/
	...
	std::vector<std::string> m_skip_env;
...
inline const std::string &DisplayConfig::skip_env(unsigned x) const
{
	return m_skip_env[x];
}

inline const std::vector<std::string> &DisplayConfig::skip_env() const
{
	return m_skip_env;
}
...
inline std::string *DisplayConfig::mutable_skip_env(unsigned x)
{
...
inline std::vector<std::string> *DisplayConfig::mutable_skip_env()
{
	return &m_skip_env;
}

inline void DisplayConfig::add_skip_env(const std::string &v)
{
...
inline void DisplayConfig::set_skip_env(unsigned x, const std::string &v)
{
...
inline size_t HardwareConfig::getMaxSize()
{
	...
	// optional DisplayConfig display, id 50 has maximum size 36
	return SIZE_MAX;
}
