...
Message *SystemConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *SystemConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *TouchpadConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *TouchpadConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *TouchChannelConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *TouchChannelConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *ButtonConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *ButtonConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *RelayConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *RelayConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *Max7219Config::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *Max7219Config::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *Tlc5947Config::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *Tlc5947Config::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *Ws2812bConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *Ws2812bConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *DhtConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *DhtConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *I2CConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *I2CConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *HcSr04Config::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *HcSr04Config::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *LedConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *LedConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *OneWireConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *OneWireConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *UartConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *UartConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *AdcChannel::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *AdcChannel::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *AdcConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *AdcConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	if (0 == strncmp("channels[",s,e-s)) {
...
Message *GpioConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *GpioConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *DisplayConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *DisplayConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *SpiDeviceConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *SpiDeviceConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *SpiBusConfig::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *SpiBusConfig::p_getMember(const char *s, const char *e, unsigned x)
{
	if (0 == strncmp("devices[",s,e-s)) {
		if (x < m_devices.size())
			return &m_devices[x];
		return 0;
	}
...
Message *GpioCluster::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *GpioCluster::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *Hlw8012Config::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *Hlw8012Config::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
Message *SX1276Config::p_getMember(const char *s, const char *e)
{
	return 0;
}

Message *SX1276Config::p_getMember(const char *s, const char *e, unsigned x)
{
	return 0;
}
...
void HardwareConfig::toWire(void (*put)(uint8_t)) const
{
	...
	for (size_t x = 0, y = m_gpio.size(); x != y; ++x) {
		// 'gpio': id=7, encoding=lenpfx, tag=0x3a
		put(0x3a);	// 'gpio': id=7
		send_varint(put,m_gpio[x].calcSize());
		m_gpio[x].toWire(put);
	}
	#ifdef CONFIG_SPI
	...
	if (0 != (p_validbits & ((uint16_t)1U << 7))) {
		...
		put(0x92);
		put(0x2);
		send_varint(put,m_ws2812b.calcSize());
		m_ws2812b.toWire(put);
	}
	#endif // CONFIG_RGBLEDS
	#ifdef CONFIG_DHT
	if (0 != (p_validbits & ((uint16_t)1U << 8))) {
...
void HardwareConfig::toString(std::string &put) const
{
	...
	for (size_t x = 0, y = m_gpio.size(); x != y; ++x) {
		// 'gpio': id=7, encoding=lenpfx, tag=0x3a
		put.push_back(0x3a);	// 'gpio': id=7
		send_varint(put,m_gpio[x].calcSize());
		m_gpio[x].toString(put);
	}
	#ifdef CONFIG_SPI
	for (size_t x = 0, y = m_spibus.size(); x != y; ++x) {
		// 'spibus': id=8, encoding=lenpfx, tag=0x42
...
Message *HardwareConfig::p_getMember(const char *s, const char *e)
{
	...
	if (0 == strncmp("adc",s,e-s))
		return &m_adc;
	#ifdef CONFIG_TOUCHPAD
	if (0 == strncmp("touchpad",s,e-s))
		return &m_touchpad;
	#endif // CONFIG_TOUCHPAD
	#ifdef CONFIG_HLW8012
	if (0 == strncmp("hlw8012",s,e-s))
		return &m_hlw8012;
	#endif // CONFIG_HLW8012
	#ifdef CONFIG_MAX7219
...
{
	if (0 == strncmp("uart[",s,e-s)) {
		if (x < m_uart.size())
			return &m_uart[x];
		return 0;
	}
	#ifdef CONFIG_TOUCHPAD
	if (0 == strncmp("tp_channel[",s,e-s)) {
