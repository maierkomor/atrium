...
{
	// port has maximum size 3
	// baudrate has maximum size 6
	// config has maximum size 3
	// rx_thresh has maximum size 2
	// tx_bufsize has maximum size 6
	// rx_bufsize has maximum size 6
	return 26;
}
...
inline size_t AppParam::getMaxSize()
{
	...
	// uValue has maximum size 6
	// sValue has unlimited size
	// dValue has maximum size 6
...
inline uint32_t EventTimer::config() const
{
	return m_config;
}
...
inline uint32_t *EventTimer::mutable_config()
{
	return &m_config;
}

inline void EventTimer::set_config(uint32_t  v)
{
	m_config = v;
}
...
inline size_t NodeConfig::getMaxSize()
{
	...
	// max_on_time has maximum size 7
	// threshold_off has maximum size 7
	// threshold_on has maximum size 7
	// dim_step has maximum size 7
	// lightctrl has maximum size 3
	// pwm_freq has maximum size 7
