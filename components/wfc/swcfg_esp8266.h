...
class NodeConfig : public Message
{
	...
	*/
	...
	uint32_t threshold_off() const __attribute__ ((deprecated));
	...
	*/
	...
	uint32_t threshold_on() const __attribute__ ((deprecated));
...
inline size_t NodeConfig::getMaxSize()
{
	...
	// deprecated optional unsigned threshold_off, id 35 has maximum size 7
	// deprecated optional unsigned threshold_on, id 36 has maximum size 7
