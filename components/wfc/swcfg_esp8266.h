...
#ifndef SWCFG_ESP8266_H
#define SWCFG_ESP8266_H
...
class WifiConfig : public Message
{
	...
	*/
	void toJSON(stream &json, bool full = true, unsigned indLvl = 0) const;
	...
	*/
	void toASCII(stream &o, bool full = true, size_t indent = 0) const;
	...
	* @param indent initial indention level
	*/
	void toPbt(stream &o, bool full = false, size_t indent = 0) const;
...
class Dref : public Message
{
	...
	*/
	...
	void set_alias(const estring &v);
...
class DataIdVar : public Message
{
	...
	*/
	...
	void set_varname(const estring &v);
...
inline size_t Dref::getMaxSize()
{
	...
	// optional unsigned freq, id 3 has maximum size 6
	return SIZE_MAX;
}

inline const estring &Dref::name() const
{
	return m_name;
}
...
inline estring *Dref::mutable_name()
{
	return &m_name;
}
...
inline void Dref::set_name(const estring &v)
{
	m_name = v;
}
...
inline const estring &Dref::alias() const
{
	return m_alias;
}
...
inline estring *Dref::mutable_alias()
{
	return &m_alias;
}
...
inline void Dref::set_alias(const estring &v)
{
	m_alias = v;
}
...
inline uint32_t Dref::freq() const
{
	return m_freq;
}
...
inline uint32_t *Dref::mutable_freq()
{
...
inline void Dref::set_freq(uint32_t v)
{
	m_freq = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
{
	// optional unsigned id, id 1 has maximum size 6
	// optional unsigned idx, id 2 has maximum size 6
	// optional string varname, id 3 has unlimited size
	return SIZE_MAX;
}

inline uint32_t DataIdVar::id() const
{
	return m_id;
}
...
inline uint32_t *DataIdVar::mutable_id()
{
	if (0 == (p_validbits & ((uint8_t)1U << vb_id))) {
		p_validbits |= ((uint8_t)1U << 0);
		m_id = 0;
...
inline void DataIdVar::set_id(uint32_t v)
{
	m_id = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline uint32_t DataIdVar::idx() const
{
	return m_idx;
}
...
inline uint32_t *DataIdVar::mutable_idx()
{
	return &m_idx;
}

inline void DataIdVar::set_idx(uint32_t v)
{
	m_idx = v;
}
...
inline const estring &DataIdVar::varname() const
{
	return m_varname;
}
...
inline estring *DataIdVar::mutable_varname()
{
	return &m_varname;
}
...
inline void DataIdVar::set_varname(const estring &v)
{
	m_varname = v;
}
...
inline size_t NodeConfig::getMaxSize()
{
	...
	// optional unsigned history, id 28 has maximum size 7
...
inline uint32_t NodeConfig::history() const
{
	return m_history;
}
...
inline uint32_t *NodeConfig::mutable_history()
{
...
inline void NodeConfig::set_history(uint32_t v)
{
	m_history = v;
	p_validbits |= ((uint16_t)1U << 12);
}
