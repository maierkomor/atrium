...
class HardwareConfig : public Message
{
	...
	*/
	...
	/*!
	* Function for querying if ws2812b has been set.
	* @return true if ws2812b is set.
	*/
	bool has_ws2812b() const;
	//! Function to reset ws2812b to its default/unset value.
	void clear_ws2812b();
	//! Get value of ws2812b.
	const Ws2812bConfig &ws2812b() const;
	/*!
	* Function for setting ws2812b using binary data.
	* @param data pointer to binary data
	* @param s number of bytes at data pointer
	*/
...
inline size_t HardwareConfig::getMaxSize()
{
	...
	// optional SystemConfig system, id 1 has maximum size 5
	...
	// optional Ws2812bConfig ws2812b, id 34 has maximum size 11
