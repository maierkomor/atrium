...
class AdcConfig
{
	...
	// unused uint8 mode, id 4
	// unused uint8 clk_div, id 5
...
{
	// port has maximum size 3
	// tx_gpio has maximum size 3
	// rx_gpio has maximum size 3
	// cts_gpio has maximum size 3
	// rts_gpio has maximum size 3
	return 15;
}
...
inline size_t AdcConfig::getMaxSize()
{
	...
	// adc1_bits has maximum size 3
	// adc2_bits has maximum size 3
	// mode is unused
	// clk_div is unused
	// hall_name has unlimited size
	// channels has unlimited size
	return SIZE_MAX;
}
...
inline size_t HardwareConfig::getMaxSize()
{
	...
	// touchpad has maximum size 18
	// tp_channel has unlimited size
