...
#ifndef HWCFG_ESP32_H
#define HWCFG_ESP32_H
...
class AdcConfig : public Message
{
	...
	*/
	...
	void set_hall_name(const estring &v);
...
class DisplayConfig : public Message
{
	...
	*/
	...
	//! Function get const-access to the elements of skip_env.
	const std::vector<estring> &skip_env() const;
	//! Function to get the number of elements in skip_env.
	size_t skip_env_size() const;
	/*!
	* Function to append a element to skip_env.
	* @return point to newly added element.
	*/
	void add_skip_env(const estring &v);
	//! Function to append an element to skip_env initialized by a C-string.
	void add_skip_env(const char*);
	//! Function to reset skip_env to its default/unset value.
	void clear_skip_env();
	//! Get value of element x of skip_env.
	const estring &skip_env(unsigned x) const;
	//! Set skip_env using a constant reference
	void set_skip_env(unsigned x, const estring &v);
	/*!
	* Provide mutable access to skip_env.
	* @return pointer to member variable of skip_env.
	*/
	estring *mutable_skip_env(unsigned x);
	//! Function to get mutable access to all elements of skip_env.
	std::vector<estring> *mutable_skip_env();
	
	
	protected:
	Message *p_getMember(const char *s, unsigned n);
	Message *p_getMember(const char *s, unsigned n, unsigned i);
	//! string skip_env, id 5
	std::vector<estring> m_skip_env;
	//! disp_t type, id 1
...
inline size_t TouchpadConfig::getMaxSize()
{
	...
	// optional unsigned interval, id 7 has maximum size 6
	return 17;
}
...
inline size_t ButtonConfig::getMaxSize()
{
	...
	// optional pull_mode_t pull_mode, id 4 has maximum size 6
...
inline size_t RelayConfig::getMaxSize()
{
	// optional string name, id 1 has unlimited size
	// optional sint8 gpio, id 2 has maximum size 3
	// optional relay_cfg_t config, id 3 has maximum size 6
	// optional unsigned min_itv, id 4 has maximum size 6
...
inline const estring &Ws2812bConfig::name() const
{
	return m_name;
}
...
inline estring *Ws2812bConfig::mutable_name()
{
	return &m_name;
}
...
inline void Ws2812bConfig::set_name(const estring &v)
{
	m_name = v;
}
...
inline size_t I2CConfig::getMaxSize()
{
	...
	// optional unsigned freq, id 4 has maximum size 6
...
inline uint32_t I2CConfig::freq() const
{
	return m_freq;
}
...
inline uint32_t *I2CConfig::mutable_freq()
{
	if (0 == (p_validbits & ((uint8_t)1U << 1))) {
		p_validbits |= ((uint8_t)1U << 1);
		m_freq = 100000;
...
inline void I2CConfig::set_freq(uint32_t v)
{
	m_freq = v;
	p_validbits |= ((uint8_t)1U << 1);
}
...
{
	// optional sint8 gpio, id 1 has maximum size 3
	// optional ledcfg_t config, id 2 has maximum size 6
	// optional string name, id 3 has unlimited size
...
inline const estring &AdcChannel::dim() const
{
	return m_dim;
}
...
inline estring *AdcChannel::mutable_dim()
{
	return &m_dim;
}
...
inline void AdcChannel::set_dim(const estring &v)
{
	m_dim = v;
}
...
#ifdef CONFIG_IDF_TARGET_ESP32
inline const estring &AdcConfig::hall_name() const
{
	return m_hall_name;
}
...
inline estring *AdcConfig::mutable_hall_name()
{
	return &m_hall_name;
}
...
inline void AdcConfig::set_hall_name(const estring &v)
{
	m_hall_name = v;
}
...
inline size_t GpioConfig::getMaxSize()
{
	// optional string name, id 1 has unlimited size
	// optional sint8 gpio, id 2 has maximum size 3
	// optional gpiocfg_t config, id 3 has maximum size 6
	return SIZE_MAX;
}
...
inline size_t DisplayConfig::getMaxSize()
{
	...
	// optional unsigned options, id 2 has maximum size 6
	// optional unsigned maxx, id 3 has maximum size 6
	// optional unsigned maxy, id 4 has maximum size 6
	// repeated string skip_env, id 5 has unlimited size
	return SIZE_MAX;
}
...
inline const estring &DisplayConfig::skip_env(unsigned x) const
{
	return m_skip_env[x];
}

inline const std::vector<estring> &DisplayConfig::skip_env() const
{
	return m_skip_env;
}
 ...
 * It will reset the value to the default value.
 */
inline void DisplayConfig::clear_skip_env()
{
	m_skip_env.clear();
}

inline estring *DisplayConfig::mutable_skip_env(unsigned x)
{
	if (x >= m_skip_env.size())
		m_skip_env.resize(x+1);
	return &m_skip_env[x];
}

inline std::vector<estring> *DisplayConfig::mutable_skip_env()
{
	return &m_skip_env;
}

inline void DisplayConfig::add_skip_env(const estring &v)
{
	m_skip_env.push_back(v);
}

inline void DisplayConfig::add_skip_env(const char *s)
{
	m_skip_env.push_back(s);
}

inline void DisplayConfig::set_skip_env(unsigned x, const estring &v)
{
	assert(x < m_skip_env.size());
	m_skip_env[x] = v;
}

inline size_t DisplayConfig::skip_env_size() const
{
	return m_skip_env.size();
}
...
inline size_t SpiDeviceConfig::getMaxSize()
{
	...
	// optional unsigned freq, id 6 has maximum size 6
	return 20;
}
...
inline uint32_t SpiDeviceConfig::freq() const
{
	return m_freq;
}
...
inline uint32_t *SpiDeviceConfig::mutable_freq()
{
	return &m_freq;
}

inline void SpiDeviceConfig::set_freq(uint32_t v)
{
	m_freq = v;
}
...
inline size_t SpiBusConfig::getMaxSize()
{
	...
	// optional spiopt_t options, id 7 has maximum size 6
...
inline const estring &GpioCluster::name() const
{
	return m_name;
}
...
inline estring *GpioCluster::mutable_name()
{
	return &m_name;
}
...
inline void GpioCluster::set_name(const estring &v)
{
	m_name = v;
}
...
{
	// optional unsigned freq, id 1 has maximum size 6
	// optional unsigned duration, id 2 has maximum size 6
	return 12;
}

inline uint32_t Tone::freq() const
{
	return m_freq;
}
...
inline uint32_t *Tone::mutable_freq()
{
	if (0 == (p_validbits & ((uint8_t)1U << 0))) {
		p_validbits |= ((uint8_t)1U << 0);
		m_freq = 0;
...
inline void Tone::set_freq(uint32_t v)
{
	m_freq = v;
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline uint32_t Tone::duration() const
{
	return m_duration;
}
...
inline uint32_t *Tone::mutable_duration()
{
	if (0 == (p_validbits & ((uint8_t)1U << 1))) {
		p_validbits |= ((uint8_t)1U << 1);
		m_duration = 0;
...
inline void Tone::set_duration(uint32_t v)
{
	m_duration = v;
	p_validbits |= ((uint8_t)1U << 1);
}
...
inline const estring &Melody::name() const
{
	return m_name;
}
...
inline estring *Melody::mutable_name()
{
	return &m_name;
}
...
inline void Melody::set_name(const estring &v)
{
	m_name = v;
}
...
inline size_t HardwareConfig::getMaxSize()
{
	...
	// optional TouchpadConfig touchpad, id 5 has maximum size 18
	...
	// optional DisplayConfig display, id 50 has maximum size 21
	return SIZE_MAX;
}
