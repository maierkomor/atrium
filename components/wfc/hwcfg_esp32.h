...
class GpioConfig : public Message
{
	...
	*/
	...
	//! Function to get the cap_freq_r2r part of bitset config.
	bool config_cap_freq_r2r() const;
	//! Function to set the cap_freq_r2r part of bitset config.
	void set_config_cap_freq_r2r(bool);
	//! Set config using a constant reference
...
inline bool GpioConfig::config_cap_freq_r2r() const
{
	return (bool)((m_config >> 9) & 0x1);
}
...
inline void GpioConfig::set_config_cap_freq_r2r(bool v)
{
	m_config &= ~(0x1ULL << 9);
	m_config |= ((uint16_t) v << 9);
	p_validbits |= ((uint8_t)1U << 0);
}
...
inline size_t HardwareConfig::getMaxSize()
{
	...
	// optional SystemConfig system, id 1 has maximum size 9
