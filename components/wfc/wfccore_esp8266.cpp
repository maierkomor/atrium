 ...
 * variant:       gen_indent
 */
void gen_indent(stream &out, ssize_t n)
{
	out.put('\n');
	while (n > 0) {
		out.put('\t');
 ...
 * variant:       gen_bytes
 */
void gen_bytes(stream &out, const uint8_t *str, size_t len, size_t indent)
{
 ...
 * variant:       gen_string
 */
void gen_string(stream &out, size_t indent, const char *str, size_t len)
{
	out << '"';
	unsigned cil = 0;
	while (len) {
 ...
 * variant:       pbt_bool
 */
void pbt_bool(stream &out, ssize_t n, const char *fname, bool v)
{
	gen_indent(out,n);
	out << fname;
	out << (v ? ": true" : ": false");
 ...
 * variant:       pbt_indent
 */
void pbt_indent(stream &out, ssize_t n, const char *fname)
{
	gen_indent(out,n);
	out << fname;
	out.put(':');
 ...
 * variant:       pbt_string
 */
void pbt_string(stream &out, size_t indent, const char *str, size_t len, const char *fname )
{
	if (fname)
